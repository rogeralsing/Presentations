...
");
            using (var system = ActorSystem.Create("system1", config))
            {
                ...
                var local = system.ActorOf(Props.Create(() => new SomeActor()).WithRouter(new FromConfig()), "localactor");
                ...
                var remote = system.ActorOf(Props.Create(() => new SomeActor()).WithRouter(new FromConfig()), "remoteactor");
